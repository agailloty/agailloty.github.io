...
description: "Apprendre comment installer Docker sur un PC Windows 10/11"
date: 2023-08-08T00:00:00Z
draft: false
type: "blog"
author: "Axel-Cleris Gailloty"
tags: [docker, devops, windows, Csharp, programming]
---
...
Alternativement, vous pouvez activer cette fonctionnalité à l'aide de Powershell.
...
* L'installation commence, Docker Desktop extrait les fichiers nécessaires à l'installation. 

* Compter environ 3 à 5 minutes en fonction de la rapidité de votre PC. 

Si vous voyez l'écran de succès, cela signifie que l'installation s'est bien passée. Vous pouvez fermer le programme d'installation puis redémarrer votre ordinateur en cliquant sur le bouton *Close and restart*.

* Vous pouvez lancer Docker Desktop via le raccourci ajouté sur votre bureau ou recherchez Docker en cliquant sur la touche Windows puis "Docker". 
